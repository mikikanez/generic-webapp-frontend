                ...
                <Grid container spacing={8} display={'flex'} justifyContent={'center'}>
                    <Grid item md={12} xs={12}>
                        <div style={{ width: "100%", height: matches ? 900 : 500, position: "relative", textAlign: "left" }}>
                            ...
                            <Box position={'absolute'} width={'50%'} height={'50%'} top='0' left='0' right='0' bottom='0' margin={'auto'} display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
                                <Typography
                                    variant="h1"
                                    textAlign={"center"}
