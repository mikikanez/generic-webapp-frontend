...
export default function Component24({ component, matches, imatges, theme, router, ...props }) {
	return (
			...
			<Container maxWidth={'xl'} style={{padding: '10%'}}>
                <Grid container spacing={8}>
                    <Grid item md={4} xs={12}>
                        <Box>
                        <Typography variant="h2" textAlign={"center"} fontWeight={"bold"} textTransform={"unset"} mb={4} color={component.dark ? "white" : "black"}>
                            {valor(0, component)}
                        </Typography>
                            <Typography
