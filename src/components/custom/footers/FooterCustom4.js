				...
				>
					...
					<Grid item md={3} xs={12} textAlign={"center"}>
						<Box textAlign={matches ? "left" : "center"}>
							<Typography variant="h3" color={isDark(footerColor) ? "white" : "black"} style={{ padding: 10 }}>
								{opcions?.titol}
							</Typography>
							<Typography variant="footer" color={isDark(footerColor) ? "white" : "black"} style={{ padding: 10 }}>
								{opcions?.descripcio}
							</Typography>
						</Box>
						<Box textAlign={matches ? "left" : "center"}>
					...
					<Grid item md={2} xs={12} textAlign={"center"} py={"0 !important"}>
						<Box
							py={2}
							style={{
								background: isDark(footerColor) ? "white" : "black",
								width: "1px",
								minHeight: "100px",
								height: "100%",
								margin: "0 auto",
                        ...
                        <Stack direction={"row"} spacing={2} justifyContent={"center"}>
                            {opcions?.instagram && (
                                <a href={opcions?.instagram} target={"_blank"} rel="noreferrer">
                                    <Instagram color={(isDark(footerColor ) ? "black" : "white")} />
                                </a>
                            )}
                            {opcions?.twitter && (
                                <a href={opcions?.twitter} target={"_blank"} rel="noreferrer">
                                    <Twitter color={(isDark(footerColor ) ? "black" : "white")} />
                                </a>
                            )}
                        </Stack>
                    </Grid> */}
