				...
				>
                    ...
                    <Grid item md={3} xs={12} textAlign={"center"}>
                        <Box textAlign={matches ? "left" : "center"}>
                            <Typography variant="h3" color={(isDark(opcions?.primary) ? "black" : "white")} style={{ padding: 10 }}>{opcions?.titol}</Typography>
                            <Typography variant="footer" color={(isDark(opcions?.primary) ? "black" : "white")} style={{ padding: 10 }}>{opcions?.descripcio}</Typography>
                        </Box>
                        <Box textAlign={matches ? "left" : "center"}>
					...
					<Grid item md={2} xs={12} textAlign={"center"} py={'0 !important'}>
				        <Box py={2} style={{ background: (isDark(opcions?.primary) ? "black" : "white"), width: '1px', minHeight: '100px', height: '100%', margin: '0 auto'}}></Box>
                    </Grid>
